...
# making or upserting collection
def ensure_collection():
    ...
    if not exists:
        ...
        print(f"upserted {COLLECTION_NAME}")

# embedding our chunks and uploading them to qdrant
with open("underwriting_clean_chunks.json", "r") as f:
    chunks = json.load(f)
